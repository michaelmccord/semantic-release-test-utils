 ...
 * @param {Object} [execaOpts] Options to pass to `execa`.
 */
async function gitAddNote(note, ref, execaOptions, noteRef) {
  await execa('git', ['notes', '--ref', noteRef, 'add', '-m', note, ref], execaOptions);
}
 ...
 * @param {Object} [execaOpts] Options to pass to `execa`.
 */
async function gitGetNote(ref, execaOptions, noteRef) {
  return (await execa('git', ['notes', '--ref', noteRef, 'show', ref], execaOptions)).stdout;
}
